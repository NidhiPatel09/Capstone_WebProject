                  ...
                  <form className="flex flex-col gap-4">
                    ...
                    <div className="relative">
                      <input
                        type="text"
                        placeholder="Title"
                        className="p-2 pl-10 border rounded w-full" // Added padding-left for space for the icon
                      />
                      <i className="fas fa-pencil-alt absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600"></i> {/* Positioned icon */}
                    </div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="p-2 pl-10 border rounded w-full" // Padding-left for icon space
                      />
                      <i className="fas fa-pen absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600"></i> {/* Positioned icon */}
                    </div>

                    <div className="relative">
                      <textarea
                        placeholder="Add More Details"
                        className="p-2 pl-10 border rounded resize-none w-full" // Padding-left for icon space
                      ></textarea>
                      <i className="fas fa-align-left absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600"></i> {/* Positioned icon */}
                    </div>
