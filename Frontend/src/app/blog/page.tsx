...
const BlogCard: React.FC<{
    ...
    <div className="rounded-lg overflow-hidden shadow">
        <img
            src={blog.image || "https://res.cloudinary.com/dyof62lts/image/upload/v1728660973/recipe8_jfh7j1.png"}
            alt={blog.title}
            ...
            <div className="p-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                {selectedBlog && (
                    <aside className="bg-dark-100 p-6 mt-10 rounded-lg shadow mb-8">
                        <div className="rounded-lg overflow-hidden shadow">
                            <img
                                src={selectedBlog.image || "https://res.cloudinary.com/dyof62lts/image/upload/v1728660973/recipe8_jfh7j1.png"}
                                alt={selectedBlog.title}
                                className="rounded w-full h-48 object-cover"
                            />
                            <div className="p-2 mt-3">
                                <h3 className="text-xl font-bold mb-4">{selectedBlog.title}</h3>
                                <p className="text-sm text-gray-400">{selectedBlog.description}</p>
                            </div>
                            <div className="p-2">
                                ...
                                <ul>
                                    {selectedBlog.ingredients.split(", ").map((ingredient, index) => (
                ...
                <div className="lg:col-span-3">
                    <h2 className="text-2xl font-bold mb-8 text-center pr-6">Our Blogs</h2>
